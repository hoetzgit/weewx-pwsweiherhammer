...
class DwdMosmix(object):
    ...
    def belchertown(self, placemark, days, recs6h, recs3h, timesteps, daynights, issue, dryrun):
        ...
        if self.belchertown_html_root and self.belchertown_forecast and self.belchertown_forecast==placemark['id']:
            fn = os.path.join(self.belchertown_html_root,'json',self.belchertown_forecast_filename)
            fnt = os.path.join(self.belchertown_html_root,'json',self.belchertown_forecast_filename+'.tmp')
        else:
