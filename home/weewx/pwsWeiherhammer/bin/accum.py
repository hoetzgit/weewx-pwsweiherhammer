...
class ScalarStats(object):
    ...
    def mergeSum(self, x_stats):
        ...
        self.sum += x_stats.sum if x_stats.sum is not None else 0.0
        self.count += x_stats.count if x_stats.count is not None else 0.0
        self.wsum += x_stats.wsum if x_stats.wsum is not None else 0.0
        self.sumtime += x_stats.sumtime if x_stats.sumtime is not None else 0.0
...
class VecStats(object):
    ...
    def mergeSum(self, x_stats):
        ...
        self.wsum += x_stats.wsum if x_stats.wsum is not None else 0.0
        self.sumtime += x_stats.sumtime if x_stats.sumtime is not None else 0.0
        self.xsum += x_stats.xsum if x_stats.xsum is not None else 0.0
        self.ysum += x_stats.ysum if x_stats.ysum is not None else 0.0
        self.dirsumtime += x_stats.dirsumtime if x_stats.dirsumtime is not None else 0.0
        self.squaresum += x_stats.squaresum if x_stats.squaresum is not None else 0.0
        self.wsquaresum += x_stats.wsquaresum if x_stats.wsquaresum is not None else 0.0
