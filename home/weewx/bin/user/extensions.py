...
weewx.units.obs_group_dict['icon_Altitude'] = 'group_altitude'
weewx.units.obs_group_dict['icon_appTemp'] = 'group_temperature'
weewx.units.obs_group_dict['icon_Barometer'] = 'group_pressure'
weewx.units.obs_group_dict['icon_Cloudcover'] = 'group_percent'
weewx.units.obs_group_dict['icon_DateTime'] = 'group_time'
weewx.units.obs_group_dict['icon_Dewpoint'] = 'group_temperature'
weewx.units.obs_group_dict['icon_Et'] = 'group_rain'
weewx.units.obs_group_dict['icon_FreezinglevelHeight'] = 'group_altitude'
weewx.units.obs_group_dict['icon_Interval'] = 'group_interval'
weewx.units.obs_group_dict['icon_Latitude'] = 'group_coordinate'
weewx.units.obs_group_dict['icon_Longitude'] = 'group_coordinate'
weewx.units.obs_group_dict['icon_OutHumidity'] = 'group_percent'
weewx.units.obs_group_dict['icon_OutTemp'] = 'group_temperature'
weewx.units.obs_group_dict['icon_Precipitation'] = 'group_rain'
weewx.units.obs_group_dict['icon_Pressure'] = 'group_pressure'
weewx.units.obs_group_dict['icon_Rain'] = 'group_rain'
weewx.units.obs_group_dict['icon_Shower'] = 'group_rain'
weewx.units.obs_group_dict['icon_Snow'] = 'group_rain'
weewx.units.obs_group_dict['icon_SnowDepth'] = 'group_rain'
weewx.units.obs_group_dict['icon_snowfallHeight'] = 'group_altitude'
weewx.units.obs_group_dict['icon_Visibility'] = 'group_distance'
weewx.units.obs_group_dict['icon_Weathercode'] = 'group_count'
weewx.units.obs_group_dict['icon_WindDir'] = 'group_direction'
weewx.units.obs_group_dict['icon_WindGust'] = 'group_speed'
weewx.units.obs_group_dict['icon_WindSpeed'] = 'group_speed'
#
...
weewx.units.obs_group_dict['icon_eu_Interval'] = 'group_interval'
...
weewx.units.obs_group_dict['icon_d2_Interval'] = 'group_interval'
...
weewx.units.obs_group_dict['icon_seamless_Interval'] = 'group_interval'
