...
class UnitedStatesAirQualityIndex(standards.AqiStandards):
    ...
    def __init__(self, obs_frequency_in_sec):
        super(UnitedStatesAirQualityIndex, self).__init__(
...
class UnitedStatesAirQualityIndexPws(standards.AqiStandards):
    '''Calculates the air quality index (AQI) as defined by the US EPA in
    https://www3.epa.gov/airnow/aqi-technical-assistance-document-may2016.pdf
    ...
    "Beyond the AQI".'''
    def __init__(self, obs_frequency_in_sec):
        super(UnitedStatesAirQualityIndexPws, self).__init__(
            [GREEN, YELLOW, ORANGE, RED, PURPLE, MAROON],
            ['Good', 'Moderate', 'Unhealthy for Sensitive Groups', 'Unhealthy', 'Very Unhealthy', 'Hazardous'],
            standards.US_AQI_PWS_ID)
...
class NowCastPws(standards.AqiStandards):
    '''Calculates the US EPA NowCast Air Quality Index (AQI) as defined by the
    US EPA in https://www3.epa.gov/airnow/aqi-technical-assistance-document-may2016.pdf
    and https://www3.epa.gov/airnow/ani/pm25_aqi_reporting_nowcast_overview.pdf .
    NowCast is meant to provide more realtime air quality measurements by
    ...
    "Beyond the AQI".'''
    def __init__(self, obs_frequency_in_sec):
        super(NowCastPws, self).__init__(
            [GREEN, YELLOW, ORANGE, RED, PURPLE, MAROON],
            ['Good', 'Moderate', 'Unhealthy for Sensitive Groups', 'Unhealthy', 'Very Unhealthy', 'Hazardous'],
            standards.US_NOWCAST_PWS_ID)
...
class UnitedStatesAirQualityIndex506(standards.AqiStandards):
    '''Calculates the air quality index (AQI) as defined by the US EPA in
    https://www3.epa.gov/airnow/aqi-technical-assistance-document-may2016.pdf
    ...
    "Beyond the AQI".'''
    def __init__(self, obs_frequency_in_sec):
        super(UnitedStatesAirQualityIndex506, self).__init__(
            [GREEN, YELLOW, ORANGE, RED, PURPLE, MAROON],
            ['Good', 'Moderate', 'Unhealthy for Sensitive Groups', 'Unhealthy', 'Very Unhealthy', 'Hazardous'],
            standards.US_AQI_506_ID)
...
class NowCast506(standards.AqiStandards):
    '''Calculates the US EPA NowCast Air Quality Index (AQI) as defined by the
    US EPA in https://www3.epa.gov/airnow/aqi-technical-assistance-document-may2016.pdf
    and https://www3.epa.gov/airnow/ani/pm25_aqi_reporting_nowcast_overview.pdf .
    NowCast is meant to provide more realtime air quality measurements by
    ...
    "Beyond the AQI".'''
    def __init__(self, obs_frequency_in_sec):
        super(NowCast506, self).__init__(
            [GREEN, YELLOW, ORANGE, RED, PURPLE, MAROON],
            ['Good', 'Moderate', 'Unhealthy for Sensitive Groups', 'Unhealthy', 'Very Unhealthy', 'Hazardous'],
            standards.US_NOWCAST_506_ID)
...
class UnitedStatesAirQualityIndex509(standards.AqiStandards):
    '''Calculates the air quality index (AQI) as defined by the US EPA in
    https://www3.epa.gov/airnow/aqi-technical-assistance-document-may2016.pdf
    ...
    "Beyond the AQI".'''
    def __init__(self, obs_frequency_in_sec):
        super(UnitedStatesAirQualityIndex509, self).__init__(
            [GREEN, YELLOW, ORANGE, RED, PURPLE, MAROON],
            ['Good', 'Moderate', 'Unhealthy for Sensitive Groups', 'Unhealthy', 'Very Unhealthy', 'Hazardous'],
            standards.US_AQI_509_ID)
...
class NowCast509(standards.AqiStandards):
    '''Calculates the US EPA NowCast Air Quality Index (AQI) as defined by the
    US EPA in https://www3.epa.gov/airnow/aqi-technical-assistance-document-may2016.pdf
    and https://www3.epa.gov/airnow/ani/pm25_aqi_reporting_nowcast_overview.pdf .
    NowCast is meant to provide more realtime air quality measurements by
    ...
    "Beyond the AQI".'''
    def __init__(self, obs_frequency_in_sec):
        super(NowCast509, self).__init__(
            [GREEN, YELLOW, ORANGE, RED, PURPLE, MAROON],
            ['Good', 'Moderate', 'Unhealthy for Sensitive Groups', 'Unhealthy', 'Very Unhealthy', 'Hazardous'],
            standards.US_NOWCAST_509_ID)
