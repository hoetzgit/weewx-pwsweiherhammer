...
# aeris-conditions = AerisWeather conditions
# aeris-metar      = AerisWeather METAR ETIC
...
class OPENMETEOthread(AbstractThread):
    ...
    # Mapping API endpoint -> OpenMeteo weather models
    WEATHERMODELS = {
        'dwd-icon': ['dwd-icon'],
        'forecast': ['best_match', 'ecmwf_ifs04', 'icon_seamless', 'icon_global', 'icon_eu', 'icon_d2']
    }
    ...
    HOURLYOBS = {
        ...
        'temperature_2m': 'outTemp',
        'relative_humidity_2m': 'outHumidity',
        'dew_point_2m': 'dewpoint', # not available in forecast model ecmwf
        'apparent_temperature': 'appTemp',
        ...
        'wind_speed_10m': 'windSpeed',
        'wind_direction_10m': 'windDir',
        'wind_gusts_10m': 'windGust', # not available in forecast model ecmwf
        # col 4
    ...
    def get_current_obs(self):
        try:
            cops = copy.deepcopy(OPENMETEOthread.WEATHEROBS[self.endpoint]['current']
        except (LookupError, TypeError):
            cops = None
        return cops
    ...
    def get_hourly_obs(self):
        try:
            hobs = copy.deepcopy(OPENMETEOthread.WEATHEROBS[self.endpoint]['hourly']
        except (LookupError, TypeError):
            hops = None
        return hobs
    ...
    def get_min15_obs(self):
        try:
            min15obs = copy.deepcopy(OPENMETEOthread.WEATHEROBS[self.endpoint]['min15']
        except (LookupError, TypeError):
            min15obs = None
        return min15obs
    ...
    def __init__(self, name, thread_dict, debug=0, log_success=False, log_failure=True):
        ...
        # Model is a list?
        self.model = weeutil.weeutil.to_list(self.config.get('model', ['dwd-icon'])


        HOHO Liste/Endpoint/Prefix,SourceID ????
    ...
    def get_data_api(self):
        ...
        # ?latitude=49.6333&longitude=12.0667
        # &current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,precipitation,rain,showers,snowfall,weather_code,cloud_cover,pressure_msl,surface_pressure,wind_speed_10m,wind_direction_10m,wind_gusts_10m
        # &minutely_15=precipitation,rain,snowfall,snowfall_height,freezing_level_height,is_day,sunshine_duration,terrestrial_radiation,shortwave_radiation_instant,direct_radiation_instant,diffuse_radiation_instant,direct_normal_irradiance_instant,terrestrial_radiation_instant
        # &hourly=temperature_2m,relative_humidity_2m,dew_point_2m,apparent_temperature,precipitation,rain,showers,snowfall,snow_depth,weather_code,pressure_msl,surface_pressure,cloud_cover,evapotranspiration,wind_speed_10m,wind_direction_10m,wind_gusts_10m,is_day,freezing_level_height,snowfall_height,sunshine_duration,shortwave_radiation_instant,direct_radiation_instant,diffuse_radiation_instant,direct_normal_irradiance_instant,terrestrial_radiation_instant
        ...
        # ?latitude=49.6333&longitude=12.0667
        # &current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,precipitation,rain,showers,snowfall,weather_code,cloud_cover,pressure_msl,surface_pressure,wind_speed_10m,wind_direction_10m,wind_gusts_10m
        # &minutely_15=temperature_2m,relative_humidity_2m,dew_point_2m,apparent_temperature,precipitation,rain,snowfall,snowfall_height,freezing_level_height,sunshine_duration,weather_code,wind_speed_10m,wind_direction_10m,wind_gusts_10m,visibility,lightning_potential,is_day,shortwave_radiation_instant,direct_radiation_instant,diffuse_radiation_instant,direct_normal_irradiance_instant,terrestrial_radiation_instant
        # &hourly=temperature_2m,relative_humidity_2m,dew_point_2m,apparent_temperature,precipitation_probability,precipitation,rain,showers,snowfall,snow_depth,weather_code,pressure_msl,surface_pressure,cloud_cover,cloud_cover_low,cloud_cover_mid,cloud_cover_high,visibility,evapotranspiration,et0_fao_evapotranspiration,vapour_pressure_deficit,wind_speed_10m,wind_direction_10m,wind_gusts_10m,soil_temperature_0cm,soil_temperature_6cm,soil_temperature_18cm,soil_temperature_54cm,soil_moisture_0_to_1cm,soil_moisture_1_to_3cm,soil_moisture_3_to_9cm,soil_moisture_9_to_27cm,soil_moisture_27_to_81cm,uv_index,uv_index_clear_sky,is_day,freezing_level_height,sunshine_duration,shortwave_radiation_instant,direct_radiation_instant,diffuse_radiation_instant,direct_normal_irradiance_instant,terrestrial_radiation_instant
        ...
        # best-match (alle Variablen bis auf snowfall_height)
        # https://open-meteo.com/en/docs/#latitude=49.6333&longitude=12.0667&current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,precipitation,rain,showers,snowfall,weather_code,cloud_cover,pressure_msl,surface_pressure,wind_speed_10m,wind_direction_10m,wind_gusts_10m&minutely_15=temperature_2m,relative_humidity_2m,dew_point_2m,apparent_temperature,precipitation,rain,snowfall,snowfall_height,freezing_level_height,sunshine_duration,weather_code,wind_speed_10m,wind_direction_10m,wind_gusts_10m,visibility,is_day,shortwave_radiation_instant,direct_radiation_instant,diffuse_radiation_instant,direct_normal_irradiance_instant,terrestrial_radiation_instant&hourly=temperature_2m,relative_humidity_2m,dew_point_2m,apparent_temperature,precipitation_probability,precipitation,rain,showers,snowfall,snow_depth,weather_code,pressure_msl,surface_pressure,cloud_cover,cloud_cover_low,cloud_cover_mid,cloud_cover_high,visibility,evapotranspiration,et0_fao_evapotranspiration,vapour_pressure_deficit,wind_speed_10m,wind_direction_10m,wind_gusts_10m,uv_index,uv_index_clear_sky,is_day,freezing_level_height,sunshine_duration,shortwave_radiation_instant,direct_radiation_instant,diffuse_radiation_instant,direct_normal_irradiance_instant&timeformat=unixtime&timezone=Europe%2FBerlin&forecast_days=1&forecast_hours=1&forecast_minutely_15=4&models=best_match
