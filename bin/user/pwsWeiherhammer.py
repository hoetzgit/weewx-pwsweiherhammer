...
class pwsWeiherhammerService(StdService):
    ...
    def __init__(self, engine, config_dict):
        ...
        option_dict = weeutil.config.deep_copy(defaults_dict['pwsWeiherhammer']['WXXTypes'])
        ...
        sunshine_coeff = float(option_dict['sunshine_time'].get('sunshine_coeff', 0.8))
        sunshine_min = float(option_dict['sunshine_time'].get('sunshine_min', 0.0))
